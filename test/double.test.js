const DoubleTests = require("../Interactive_UI/double_fun");
...
describe('Tests', () => {
    describe('testNochange', () => {
        ...
        it('should return false when nodes are different', () => {
            ...
            const testInstance = new DoubleTests(nodes1, nodes2);
            const result = testInstance.testNochange();
    ...
    describe('testAdd', () => {
        it('should return true when the node is added', () => {
            ...
            const testInstance = new DoubleTests(newNodes, oldNodes);
